...
//    droplist += '<li><a href="/smartlink/api#authentication">Authentication <span>(1)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#ads">Ads <span>(3)</span></a></li>';
    droplist += '<li><a href="/smartlink/api#lists">Lists <span>(3)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#accounts">Accounts <span>(3)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#categories">Categories <span>(2)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#clipboard">Clipboard <span>(3)</span></a></li>';
    droplist += '<li><a href="/smartlink/api#products">Products <span>(2)</span></a></li>';
    droplist += '<li><a href="/smartlink/api#suppliers">Suppliers <span>(2)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#saved_searches">Saved Searches <span>(4)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#recent_searches">Recent Searches <span>(1)</span></a></li>';
    droplist += '<li><a href="/smartlink/api#media">Media <span>(1)</span></a></li>';
//    droplist += '<li><a href="/smartlink/api#legal">Legal <span>(2)</span></a></li>';
    droplist += '</ul>';
    droplist += '</li></ul></div>';
