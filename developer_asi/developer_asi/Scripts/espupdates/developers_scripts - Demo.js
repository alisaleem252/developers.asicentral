...
function fixAction(form) {
    _applicationID = $('#userID').val();
    _applicationSecret = $('#userPass').val();
    var $form = $(form);
    ...
    ////newAction = 'http://M129:8020/productService/api/9207/pid/9207-550078146';
    ////newAction = 'https://stage-productservice.asicentral.com/productService/api/9207/pid/9207-550078146';
    //newAction = 'https://stage-productservice.asicentral.com/productService/api/{companyId}/pid/{externalProductId}';
    newAction = newAction.replace('?&', '?');
    newAction = apiURL + newAction;
    console.log(newAction);
    ...
    $.ajax({
        ...
        Accept: dtype,
        dataType: otype,
        data: ($formMethod.toLowerCase() === 'post') ? $form.find('textarea').val() : '',
        ...
        beforeSend: function (xhr) {
            ...
            if ($isSecure > -1 && _applicationID && _applicationSecret) {
                ...
                //xhr.setRequestHeader('Authorization', make_base_auth(_applicationID,_applicationSecret));
                ////xhr.setRequestHeader('Authorization', 'Basic Y3VzdG9tZXIxOnBhc3N3b3Jk');
            }
		}
    });
    return false;
